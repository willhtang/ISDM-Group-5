...
RM are responsible for handling the interaction with the customers. They facilitate the transaction of the holiday packages provided by the company to customer via telephone call.  The implementation of the new system will allow for adjustment of the call flow rate to suitable RM and thus be able to serve their end-customers (or potential customer).
